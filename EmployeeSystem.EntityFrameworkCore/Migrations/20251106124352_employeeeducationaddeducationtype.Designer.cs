...
namespace EmployeeSystem.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20251106124352_employeeeducationaddeducationtype")]
    partial class employeeeducationaddeducationtype
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EmployeeSystem.Domain.Models.CV", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EmployeeSystem.Domain.Models.Employee", b =>
                {
                    ...
                    b.Property<string>("CurrentMohallah")
                        .HasMaxLength(200)
                    ...
                    b.Property<string>("CurrentTehsil")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("EmployeeSystem.Domain.Models.CV", b =>
                {
                    b.HasOne("EmployeeSystem.Domain.Models.JobDescription", "JobDescription")
                        .WithMany()
                        .HasForeignKey("JobDescriptionId");

                    b.HasOne("EmployeeSystem.Domain.Models.PostHost", "PostHost")
                        .WithMany()
                        .HasForeignKey("PostHostId");

                    b.Navigation("JobDescription");

                    b.Navigation("PostHost");
                });
